...
public class OkHttpClientManager {
            ...
            public void onResponse(final Response response) {
                try {
                    ...
                    if (callback.mType == String.class) {
                        ...
                        String s = mGson.fromJson(string,callback.mType);
                        Object o = mGson.fromJson(string, callback.mType);
                        sendSuccessResultCallback(s, callback);
                    }
    ...
    private void sendSuccessResultCallback(final String s, final ResultCallback callback) {
        mDelivery.post(new Runnable() {
            @Override
            public void run() {
                if (callback != null) {
